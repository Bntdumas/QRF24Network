...
void QRF24Network::begin(quint8 _channel, quint16 _node_address )
{
    ...
    connect(m_worker, SIGNAL(newData(QString,quint64)), this, SIGNAL(newData(QString,quint64)), Qt::QueuedConnection);
    connect(this, SIGNAL(startThread(QRF24Network*)), m_worker, SLOT(mainRadioLoop(QRF24Network*)), Qt::QueuedConnection);
