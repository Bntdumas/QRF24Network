...
/**
 * Driver for nRF24L01(+) 2.4GHz Wireless Transceiver, using Qt libs
 */
...
public:
   ...
   */
    ...
    /**
   * Generats a giant block of debugging information
   * @param displayDetails, if true display the debug output to stdout
   */
    QString getDetails(bool displayDetails = true);
...
protected:
   ...
   */
    ...
    /**
   * Decode and returns the given status as QString
   *
   ...
   */
    ...
    /**
   * Decode returns the given  'observe_tx' as QString
   *
   ...
   */
    ...
    /**
   * Returns the name and value of an 8-bit register
   *
   ...
   */
    ...
    /**
   * Returns the name and value of a 40-bit address register
   *
   * Optionally it can print some quantity of successive
   * registers on the same line.  This is useful for printing a group
   * of related registers on one line.
